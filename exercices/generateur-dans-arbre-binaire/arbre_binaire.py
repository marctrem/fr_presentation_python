...
# Vous devez compléter le code de la métode parcours_gen déclarée plus bas.
...
class ArbreBinaire:
    ...
    def parcours_gen(self, noeud=None):
        # Vous pouvez modifier la signature comme vous le voullez. Tans que `parcours_gen()` reste un appel valide.
